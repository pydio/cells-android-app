...
It supports both Cells (v2 to v5) and the legacy Pydio PHP (Pydio 6, 7 and 8) servers.  
...
- The cornerstone of the app is in the `cells-client` folder that is maintained
...
Copyright 2026 Wire France SAS.
